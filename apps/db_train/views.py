...
class TrainView(View):
    def get(self, request):
        ...
        self.answer3 = Tag.objects.filter(
        ...
        self.answer6 = AuthorProfile.objects.filter(stage__range=(1, 5)).values_list('author__username', flat=True) # TODO Какие авторы имеют стаж от 1 до 5 лет?
        ...
        self.answer10 =Author.objects.annotate(num_entries=Count('entries')).values('username', 'num_entries') # TODO Сколько статей написано каждым автором?
